...
let settings = {
    ...
    sequence: 'HAPPY|BIRTHDAY|TO|YOU|TITHI|❤',
    sequenceColor: '#ff69b4', // Pink color
    gift: '', // No sticker/GIF
    pages: [
        { image: './image/Birthday!/cover.jpg', content: '' }, // Front cover
{ image: './image/Birthday!/photo1.jpg', content: 'Happy Birthday, Radio 📻… still talking non-stop today too huh? 😌' },

{ image: './image/Birthday!/photo2.png', content: 'Breaking News 🚨 Local Radio cries over small things again today 🥹' },

{ image: './image/Birthday!/photo3.png', content: 'You act strong… but cry like a baby after 2 minutes 😤🧸' },

{ image: './image/Birthday!/photo4.png', content: 'Lowkey jealous type huh? Don’t worry… I only annoy you this much 😏' },

{ image: './image/Birthday!/photo5.png', content: 'But okay… today I’ll be nice. Happy Birthday, you cute crybaby 💕' },

{ image: './image/Birthday!/photo6.png', content: 'I joke a lot… but you’re actually kinda special to me 🙂' },

{ image: './image/Birthday!/photo7.png', content: 'Don’t get the wrong idea… but staying with you is kinda nice ❤️' },

{ image: './image/Birthday!/photo8.jpg', content: 'Even if distance exists… my favorite Radio station is still you 📻✨' },
...
{ image: './image/Birthday!/photo4.png', content: 'I joke a lot… but you’re actually kinda special to me 🙂' },

{ image: './image/Birthday!/photo5.png', content: 'But okay… today I’ll be nice. Happy Birthday, you cute crybaby 💕' },

{ image: './image/Birthday!/photo6.png', content: 'Lowkey jealous type huh? Don’t worry… I only annoy you this much 😏' },
